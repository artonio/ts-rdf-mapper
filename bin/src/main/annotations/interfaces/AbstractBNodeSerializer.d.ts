import { BlankNode, Literal, NamedNode, Prefixes, Triple } from 'n3';
/**
 * Convenience alias type for Triple from 'n3'
 */
export declare type RDFTriple = Triple;
/**
 * Convenience alias type for Literal from 'n3'
 */
export declare type RDFLiteral = Literal;
/**
 * Convenience alias type for NamedNode from 'n3'
 */
export declare type RDFResourceIRI = NamedNode;
/**
 * Convenience alias type for BlankNode from 'n3'
 */
export declare type RDFBlankNode = BlankNode;
export declare type Triple_Subject = RDFResourceIRI | RDFBlankNode;
export declare type Triple_Predicate = RDFResourceIRI;
export declare type Triple_Object = RDFResourceIRI | RDFLiteral | RDFBlankNode;
 ...
 * ```
 */
export declare abstract class AbstractBNodeSerializer {
    /**
     ...
     */
    protected readonly xsdType: RDFResourceIRI;
    /**
     * @hidden
     */
    protected readonly isBnodeSerializer: boolean;
    /**
     * @hidden
     */
